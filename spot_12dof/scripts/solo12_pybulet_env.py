...
class Solo12PybulletEnv(gym.Env):
    ...
    def do_simulation(self, action, n_frames):
        ...
        for _ in range(n_frames):
            ii = ii + 1
            applied_motor_torque = self.apply_pd_control(m_angle_cmd_ext)
            self._pybullet_client.stepSimulation()
        ...
        plane_normal, self.support_plane_estimated_roll, self.support_plane_estimated_pitch = normal_estimator.vector_method_solo12(
